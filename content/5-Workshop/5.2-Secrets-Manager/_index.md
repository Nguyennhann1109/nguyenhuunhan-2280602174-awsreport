...
![Select type and value for db-password](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.2-Secrets-Manager/db-password-1.png)
![Configure name and description for db-password](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.2-Secrets-Manager/db-password-2.png)
...
![Select type and value for jwt-secret](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.2-Secrets-Manager/jwt-secret-1.png)
![Configure name for jwt-secret](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.2-Secrets-Manager/jwt-secret-2.png)
...
![Select type and value for redis-auth-token](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.2-Secrets-Manager/redis-token-1.png)
![Configure name for redis-auth-token](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.2-Secrets-Manager/redis-token-2.png)
...
![Select type and values for twilio credentials](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.2-Secrets-Manager/twilio-credentials-1.png)
![Configure name for twilio credentials](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.2-Secrets-Manager/twilio-credentials-2.png)
