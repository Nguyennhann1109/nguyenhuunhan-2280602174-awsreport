...
![Create Target Group API - Configure Port](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.9-Load-Balancer/tg-api-1.png)
...
![Create Target Group API - Health Check Path](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.9-Load-Balancer/tg-api-2.png)
![Create Target Group API - Health Check Advanced](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.9-Load-Balancer/tg-api-3.png)
...
![Create Target Group WS - Configure Port](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.9-Load-Balancer/tg-ws-1.png)

- **VPC**: Select realtime-collab-dev
![Create Target Group WS - Health Check Path](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.9-Load-Balancer/tg-ws-2.png)

- **Health checks**:
  - Health check path: `/health`
  - Advanced settings: Interval: `15s` | Timeout: `5s` | Healthy: `2` | Unhealthy: `2` | Success: `200`

![Create Target Group WS - Health Check Advanced](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.9-Load-Balancer/tg-ws-3.png)
![Create Target Group WS - Stickiness Enable](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.9-Load-Balancer/tg-ws-4.png)
...
![Create ALB - Name and Scheme](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.9-Load-Balancer/alb-create-1.png)
...
![Create ALB - Network Mappings Subnets](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.9-Load-Balancer/alb-create-2.png)
...
![Create ALB - Security Groups](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.9-Load-Balancer/alb-create-3.png)
![Create ALB - Listeners default action 404](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.9-Load-Balancer/alb-create-4.png)
...
![Configure Idle Timeout for ALB - Attributes tab](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.9-Load-Balancer/alb-idle-1.png)
![Configure Idle Timeout for ALB - Change to 3600](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.9-Load-Balancer/alb-idle-2.png)
...
![Add Listener Rules for HTTP:80](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.9-Load-Balancer/alb-rules-1.png)
...
3. **Add Rule 1 — REST API**:
   ...
   ![Route Rule 1 REST API /api/*](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.9-Load-Balancer/alb-rules-2.png)
   ![Route Rule 1 REST API Forward](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.9-Load-Balancer/alb-rules-3.png)
   ![Route Rule 1 REST API Forward](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.9-Load-Balancer/rule-1.png)
...
![Route Rule 2 WebSocket /ws/*](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.9-Load-Balancer/alb-rules-4.png)
![Route Rule 2 WebSocket Forward](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.9-Load-Balancer/alb-rules-5.png)
![Listener Rules List configured successfully](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.9-Load-Balancer/alb-rules-6.png)
