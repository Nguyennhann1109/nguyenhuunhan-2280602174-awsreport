...
![Khởi tạo Redis Cache Subnet Group](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.7-ElastiCache-Redis/redis-subnet-group-create.png)
...
![Khởi tạo Redis - Cấu hình Settings Phần 1](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.7-ElastiCache-Redis/redis-create-settings-1.png)
...
![Khởi tạo Redis - Cấu hình Settings Phần 2](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.7-ElastiCache-Redis/redis-create-settings-2.png)
...
![Khởi tạo Redis - Cache settings](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.7-ElastiCache-Redis/redis-create-settings-3.png)
...
![Khởi tạo Redis - Kết nối Connectivity](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.7-ElastiCache-Redis/redis-create-advanced-1.png)
...
![Khởi tạo Redis - Advanced Settings](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.7-ElastiCache-Redis/redis-create-advanced-2.png)
...
![Khởi tạo Redis - Advanced Settings](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.7-ElastiCache-Redis/redis-create-advanced-3.png)

##### 2. Backup & Maintenance
- **Enable automatic backups**: Bỏ tích chọn.
- **Auto minor version upgrade**: Tích chọn **Enable**.

![Danh sách cụm Redis ở trạng thái khởi tạo](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.7-ElastiCache-Redis/redis-create-status.png)
