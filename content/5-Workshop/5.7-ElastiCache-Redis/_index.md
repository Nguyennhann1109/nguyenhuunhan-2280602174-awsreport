...
![Create Redis Cache Subnet Group](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.7-ElastiCache-Redis/redis-subnet-group-create.png)
...
![Configure Redis Settings Part 1](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.7-ElastiCache-Redis/redis-create-settings-1.png)
...
![Configure Redis Settings Part 2](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.7-ElastiCache-Redis/redis-create-settings-2.png)
...
![Configure Redis Settings Part 3](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.7-ElastiCache-Redis/redis-create-settings-3.png)
...
![Configure Redis Connectivity](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.7-ElastiCache-Redis/redis-create-advanced-1.png)
...
![Configure Redis Advanced Security & Auth Token](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.7-ElastiCache-Redis/redis-create-advanced-2.png)

- **Selected security groups**: Click **Manage** ➔ Select **redis-sg** created in Step 4 (ensure default is unchecked) ➔ click **Save**.

![Configure Redis Security Groups](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.7-ElastiCache-Redis/redis-create-advanced-3.png)

##### 2. Backup & Maintenance
- **Enable automatic backups**: Uncheck.
- **Auto minor version upgrade**: Select **Enable**.

![Redis Cluster List Status](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.7-ElastiCache-Redis/redis-create-status.png)
