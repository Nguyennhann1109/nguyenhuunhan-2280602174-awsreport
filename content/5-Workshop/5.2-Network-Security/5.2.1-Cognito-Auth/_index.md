...
![Create Cognito User Pool](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.2-Network-Security/5.2.1-Cognito-Auth/create-user-pool.png)
...
![Create Cognito User Pool](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.2-Network-Security/5.2.1-Cognito-Auth/define-your-app.png)
...
![Create Cognito User Pool](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.2-Network-Security/5.2.1-Cognito-Auth/configure-options.png)
4. Under **Add a return URL - optional**: Enter `http://localhost`.
5. Click **Create user directory** at the bottom right of the page.
![Create Cognito User Pool](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.2-Network-Security/5.2.1-Cognito-Auth/add-a-return.png)
...
![Extract credentials](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.2-Network-Security/5.2.1-Cognito-Auth/user-pool-id.png)
3. Navigate to the **App integration** tab ➔ Scroll down to the **App client list** ➔ Copy the **Client ID** (e.g., `3n70abcde...`).
![Extract credentials](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.2-Network-Security/5.2.1-Cognito-Auth/client-id.png)
