...
![Khởi tạo Distribution - Chọn gói cước](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.10-CloudFront/cf-origin-1.png)
...
![Khởi tạo Distribution - Get started](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.10-CloudFront/cf-origin-2.png)
...
![Khởi tạo Distribution - Specify origin](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.10-CloudFront/cf-origin-3.png)
...
![Copy policy từ CloudFront](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.10-CloudFront/cf-policy-1.png)

![Copy policy từ CloudFront](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.10-CloudFront/copy-policy.png)

4. Chọn tab Permissions ➔ cuộn xuống Bucket policy ➔ nhấp vào Edit ➔ dán chính sách JSON đã sao chép ➔ nhấp vào Save change.


![Dán Bucket Policy trong S3 Permissions](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.10-CloudFront/cf-policy-2.png)

![Origins tab list](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.10-CloudFront/cf-alb-1.png)
...
![Khởi tạo ALB Backend Origin](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.10-CloudFront/cf-alb-2.png)
...
![Khởi tạo ALB Backend Origin](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.10-CloudFront/cf-behavior-1.png)
...
![Cấu hình Behavior cho Path /api/*](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.10-CloudFront/cf-behavior-2.png)
...
* **Tạo Behavior 1 (Dành cho `/api/*` REST API)**:
  ...
  ![Error Pages tab](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.10-CloudFront/cf-error-1.png)
...
* **Tạo Behavior 2 (Dành cho `/ws/*` WebSockets)**:
  ...
  ![Cấu hình Custom Error Response 403](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.10-CloudFront/cf-error-2.png)
...
![Cấu hình Custom Error Response 404](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.10-CloudFront/cf-error-3.png)
...
2. Thiết lập lỗi 403:
   ...
   ![Danh sách Custom Error Responses](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.10-CloudFront/cf-error-4.png)
...
3. Tiếp tục bấm **Create custom error response** để thiết lập lỗi 404:
   ...
   ![General Settings Edit click](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.10-CloudFront/cf-general-1.png)

##### 4. Cấu hình Root Object & IPv6
1. Di chuyển sang tab **General** ➔ Tại mục **Settings**, bấm nút **Edit**.

![Cấu hình Default Root Object index.html](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.10-CloudFront/cf-general-2.png)
...
![Địa chỉ Domain name CloudFront hoàn thành](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.10-CloudFront/cf-domain.png)
