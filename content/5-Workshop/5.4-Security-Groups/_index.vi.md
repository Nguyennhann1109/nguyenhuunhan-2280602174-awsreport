...
![Cấu hình inbound rule cho alb-sg](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.4-Security-Groups/alb-sg.png)
...
![Cấu hình inbound rule cho unified-backend-sg](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.4-Security-Groups/unified-backend-sg.png)

##### 2.3 Rules cho rds-sg
- **Inbound Rules**:
  - Type: PostgreSQL | Port: `5432` | Source: chọn backend-sg

![Cấu hình inbound rule cho rds-sg](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.4-Security-Groups/rds-sg.png)

##### 2.4 Rules cho redis-sg
- **Inbound Rules**:
  - Type: Custom TCP | Port: `6379` | Source: chọn backend-sg

![Cấu hình inbound rule cho redis-sg](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.4-Security-Groups/redis-sg.png)
