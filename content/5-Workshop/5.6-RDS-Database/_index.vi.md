...
![Khởi tạo DB Subnet Group](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.6-RDS-Database/db-subnet-group-create.png)
...
![Khởi tạo Parameter Group](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.6-RDS-Database/db-subnet-group-details.png)
...
![Eidt Parameter Group](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.6-RDS-Database/db-parameter-group-create.png)

![Bắt buộc sử dụng mã hoá SSL](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.6-RDS-Database/db-parameter-group-edit.png)
...
![Khởi tạo Database - Engine Options](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.6-RDS-Database/db-create-engine.png)

- **Availability and durability**: **Multi-AZ DB instance**

![Khởi tạo Database - Settings & Credentials](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.6-RDS-Database/2az.png)
...
![Khởi tạo Database - Master Password](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.6-RDS-Database/db-create-settings-2.png)
...
![Khởi tạo Database - Instance Type](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.6-RDS-Database/db-create-instance.png)
![Khởi tạo Database - Storage Autoscaling](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.6-RDS-Database/db-create-storage.png)
- **Connectivity**:
...
![Khởi tạo Database - Connectivity Part 1](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.6-RDS-Database/db-create-network-1.png)
![Khởi tạo Database - Connectivity Part 2](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.6-RDS-Database/db-create-network-2.png)
- **Additional configuration**:
  - **Initial database name**: `realtime_collab`
  - **DB parameter group**: Chọn `realtime-collab-dev-pg15-ssl`
![Khởi tạo Database - Additional Configuration Part 1](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.6-RDS-Database/db-create-additional-1.png)
  - **Backup**:
    - Backup retention period: 7 days
    - Backup window: Chọn 03:00 - 04:00 UTC
    - **Copy tags to snapshots**: **Tích chọn**

![Khởi tạo Database - Additional Configuration Part 2](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.6-RDS-Database/db-create-additional-2.png)
...
![Khởi tạo Database - Additional Configuration Part 3](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.6-RDS-Database/db-create-additional-3.png)
