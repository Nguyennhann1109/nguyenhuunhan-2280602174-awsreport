...
![Create DB Subnet Group](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.6-RDS-Database/db-subnet-group-create.png)
...
![Create Parameter Group](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.6-RDS-Database/db-subnet-group-details.png)
...
![Edit Parameter Group](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.6-RDS-Database/db-parameter-group-create.png)

![Enforce SSL encryption](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.6-RDS-Database/db-parameter-group-edit.png)
...
![Database creation Engine Options](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.6-RDS-Database/db-create-engine.png)

- **Availability and durability**: **Multi-AZ DB instance**

![Database Settings & Credentials](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.6-RDS-Database/2az.png)
...
![Database Master Password settings](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.6-RDS-Database/db-create-settings-2.png)
...
![Database Instance Type](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.6-RDS-Database/db-create-instance.png)
![Database Storage Autoscaling](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.6-RDS-Database/db-create-storage.png)
- **Connectivity**:
...
![Database Connectivity Part 1](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.6-RDS-Database/db-create-network-1.png)
![Database Connectivity Part 2](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.6-RDS-Database/db-create-network-2.png)
- **Additional configuration**:
  - **Initial database name**: `realtime_collab`
  - **DB parameter group**: Select `realtime-collab-dev-pg15-ssl`
  
![Database Additional Configuration Part 1](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.6-RDS-Database/db-create-additional-1.png)
  - **Backup**:
    - Backup retention period: 7 days
    - Backup window: Select 03:00 - 04:00 UTC
    - **Copy tags to snapshots**: **Check**

![Database Additional Configuration Part 2](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.6-RDS-Database/db-create-additional-2.png)
...
![Database Additional Configuration Part 3](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.6-RDS-Database/db-create-additional-3.png)
