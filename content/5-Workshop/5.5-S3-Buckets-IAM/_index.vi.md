...
![Khởi tạo S3 Frontend - Tên và Vùng](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.5-S3-Buckets-IAM/s3-frontend-1.png)
![Khởi tạo S3 Frontend - Block Public Access và Versioning](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.5-S3-Buckets-IAM/s3-frontend-2.png)
![Khởi tạo S3 Frontend - Encryption](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.5-S3-Buckets-IAM/s3-frontend-3.png)
...
![Cấu hình Bucket Policy cho Frontend](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.5-S3-Buckets-IAM/s3-frontend-policy.png)
...
![Cấu hình Bucket Policy cho Files](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.5-S3-Buckets-IAM/s3-files-policy.png)

- **Lifecycle rules** (Tab Management ➔ Create lifecycle rule):
![Cấu hình Bucket Policy cho Files](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.5-S3-Buckets-IAM/s3-files-cors.png)

  - **Rule 1**: Tên `archive-workspace-files` | Prefix: `workspace-` | Action: Chuyển sang lưu trữ Glacier sau 90 ngày.

  ![Cấu hình Lifecycle Rules 1 cho Files](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.5-S3-Buckets-IAM/s3-files-lifecycle-rule-1.1.png)

  ![Cấu hình Lifecycle Rules 1 cho Files](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.5-S3-Buckets-IAM/s3-files-lifecycle-rule-1.2.png)

  - **Rule 2**: Tên `abort-incomplete-multipart` | Prefix: Để trống | Action: Hủy các tệp tải lên dở dang sau 7 ngày.

![Cấu hình Lifecycle Rules 2 cho Files](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.5-S3-Buckets-IAM/abort-incomplete-multipart-1.png)

![Cấu hình Lifecycle Rules 2 cho Files](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.5-S3-Buckets-IAM/abort-incomplete-multipart-2.png)
...
- **Cross-origin resource sharing (CORS)** (Tab Permissions ➔ CORS):
  ...
  ![Cấu hình CORS cho Files](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.5-S3-Buckets-IAM/file-CORS-1.png)

  ![Cấu hình CORS cho Files](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.5-S3-Buckets-IAM/file-CORS-2.png)
...
3. Trong giao diện tạo Role:
   ...
   ![Khởi tạo ECS Task Execution Role](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.5-S3-Buckets-IAM/create-role-1.png)
...
![Khởi tạo ECS Task Execution Role](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.5-S3-Buckets-IAM/create-role-2.png)
...
```
![Tạo Inline Policy ecr-pull](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.5-S3-Buckets-IAM/ecr-pull-policy.png)

* Bấm **Next**, đặt tên Policy là `ecr-pull` và chọn **Create policy**.

![Tạo Inline Policy ecr-pull](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.5-S3-Buckets-IAM/iam-exec-policy-ecr.png)
...
```
![Tạo Inline Policy secrets-execution](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.5-S3-Buckets-IAM/cloudwatch-logs-ecs.png)
...
```
![Tạo Inline Policy secrets-execution](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.5-S3-Buckets-IAM/iam-exec-policy-secrets.png)
...
2. Chọn cấu hình tương tự như Bước 1:
   ...
   ![Khởi tạo ECS Task Role](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.5-S3-Buckets-IAM/iam-task-role-create.png)
...
![Khởi tạo ECS Task Role](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.5-S3-Buckets-IAM/ecsTaskRole-realtime-collab-dev.png)
...
```
![Tạo Inline Policy s3-file-storage](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.5-S3-Buckets-IAM/iam-task-policy-s3.png)
...
```
![Tạo Inline Policy secrets-task](/nguyenhuunhan-2280602174-awsreport/images/5-Workshop/5.5-S3-Buckets-IAM/secrets-task.png)
